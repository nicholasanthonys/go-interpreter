...
func (l *Lexer) readChar() {
	// if we have reached the end of input, set l.ch to 0 which is the ASCII code for
	// the Nul Character
...
// it contains the check ch == '_', which means that
...
// sometimes consumeWhitespace and sometimes something entirely different
